...
class WelcomePage extends React.Component {
    ...
    render() {
		...
		cardClasses = 'mdl-card mdl-shadow--4dp hover'
        ...
        return (
                <div id="WelcomePage" className="text-center">
                    ...
                    <Grid>
                        ...
                        <Cell col={4} tablet={4} phone={12} className={cardClasses}>
                    ...
                    <Grid>
                        <Cell col={6} tablet={4} phone={12} className={cardClasses}>

...
const Top5Assets = (props) => {
  	...
  	function renderRows() {
		return props.systems.map( system => {
			const 	months = get(system, 'calculatable.RATING.vector.GR.months')
					monthlyGrowthD = get(system, 'calculatable.RATING.vector.GR.monthlyGrowthD')
    ...
    const 	cmgrTP = 	<span>
							Key indicator that shows
							<br/> long term profitability of
							<br/> investment. We use monthly
							<br/> calculation in opposite to
							<br/> annual in traditional finance
							<br/> as blockchain markets are
							<br/> faster than tradational thus
							<br/> should be evaulated more
							<br/> frequently.
						</span>,
			ratingTP = 	<span>
							Compound evaluation of a
							<br/> given crypto property.
							<br/>Methodology depend on
							<br/> a stage, type and class
							<br/> of a given cryptoproperty.
							<br/>More than 50 indicators are
							<br/> evaluated in a realtime.
						</span>,
			monthsTP = 	<span>
							This is time passed since
							<br/> time of sampling 'first price'
							<br/> metric.
						</span>

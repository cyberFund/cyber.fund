...
var cfEs = {
  ...
  getTransform: function(queryName) {
    //this == cfEs
    if (this.queries[queryName] && _.isFunction(this.queries[queryName].transform)) {
      return this.queries[queryName].transform;
    }
  ...
  sendQuery: function(queryName, params) {
    ...
    var queryObject = this.queries[queryName].getQueryObj(params);
    //console.log(this._client);
    return this._client.search(queryObject);
  },

  isClientQueryAllowed: function(queryName) {
    return this.queries[queryName] && this.queries[queryName].clientAllowed;
  }
};

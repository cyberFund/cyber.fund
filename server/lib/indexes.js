...
*/
	...
	CurrentData._ensureIndex({"calculatable.GR.monthlyGrowthB": 1}, {sparse: true});
	CurrentData._ensureIndex({"calculatable.GR.monthlyGrowthD": 1}, {sparse: true});
	CurrentData._ensureIndex({"calculatable.GR.months": 1}, {sparse: true});
	CurrentData._ensureIndex({"calculatable.GR.sum": 1}, {sparse: true});
	CurrentData._ensureIndex({"calculatable.WL.sum": 1}, {sparse: true});
	CurrentData._ensureIndex({"calculatable.LV.sum": 1}, {sparse: true});

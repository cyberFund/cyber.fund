  ...
  this.route("Radar", {
    ...
    data: function () {
      return {
        ...
        crowdsalePast: CurrentData.find({$and: [CF.Chaingear.selector.crowdsales,
          {'crowdsales.end_date': {$lt: new Date()}}] }, {sort: {'crowdsales.end_date': -1}}),
        crowdsaleUpcoming: CurrentData.find({$and: [CF.Chaingear.selector.crowdsales,
          {'crowdsales.start_date': {$gt: new Date()}}] }),
        crowdsaleActive: CurrentData.find({$and: [CF.Chaingear.selector.crowdsales,

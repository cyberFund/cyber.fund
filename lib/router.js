...
Router.map(function () {
    ...
    this.route("system2", {
        ...
        data: function () {
            var name = Blaze._globalHelpers._toS(this.params.name_), symbol = this.params.symbol;
            return {
        ...
        waitOn: function () {
            var name = Blaze._globalHelpers._toS(this.params.name_);
            return [
                Meteor.subscribe('systemData', {name: this.params.name_, symbol: this.params.symbol}),
    ...
    this.route("system1", {
        ...
        waitOn: function () {
            var name = Blaze._globalHelpers._toS(this.params.name_);
            return [
                Meteor.subscribe('systemData', {name: this.params.name_})
            ]
        }
    })
})

  ...
  this.route("Profile", {
    ...
    onRun: function(){
      ...
      Tracker.autorun(function () {
        self.subs.users = Meteor.subscribe('friendlyUsers', CF.Profile.currentUid.get());
        ...
        if (systems && systems.length) {
          self.subs.systems = Meteor.subscribe('profilesSystems', systems);
        }
      });
      this.next();
    },
    ...
    onStop: function () {
      if (this.subs.users) this.subs.users.stop();
      if (this.subs.systems) this.subs.systems.stop();
      this.next();
    }
  })
});
